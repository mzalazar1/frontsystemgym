    ...
    return (
        <div className={styles.frmLogPago}>
            ...
            }
            {
                modFallaLog ?
                    <Modal
                        texto='Falló al cargar el nuevo log'
                        tipo='nuevoLog' /> : <div></div>
            }
            <h2>Formulario</h2>
            <form onSubmit={handleSubmit(logHandler)}>
                ...
                <div>
                    ...
                    />
                    {errors.accion && <span className={styles.claseError}>{errors.accion.message}</span>}
                </div>
                <div>
                    <label>Usuario</label>
                    <SocInput
                    ...
                    />
                    {errors.usuario && <span className={styles.claseError}>{errors.usuario.message}</span>}
                </div>
                <div>
                    <label>Fecha</label>
                    <SocInput
                    ...
                    />
                    {errors.fecha && <span className={styles.claseError}>{errors.fecha.message}</span>}
                </div>
                <div>
                    <label>Hora</label>
                    <SocInput
                    ...
                    />
                    {errors.hora && <span className={styles.claseError}>{errors.hora.message}</span>}
                </div>
                <Boton
                    tipo='logABM'
                    texto='Enviar' />
